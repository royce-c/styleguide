                            ...
                            <div className="relative my-6 px-8 col-span-12 sm:col-span-12 md:col-span-7 lg:col-span-7 xxl:col-span-7">
                                ...
                                <div>
                                    <div className='flex justify-center'>
                                        <div className={`shadow-2xl rounded-lg w-3/6 h-80 overflow-hidden backgroundImage2`} />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="relative  bg-teal-600 h-full md:h-96 w-full bg-opacity-50 rounded-tr-lg rounded-br-lg">
                                    <div className="p-4">
                                        ...
                                        <p className="text-slate-300 text-xs md:text-sm lg:text-xl mb-4 pt-4">
                                            For the Icons that we selected from HeroIcons. We have chosen to keep them smaller as they are mainly for navigation.                              </p>
